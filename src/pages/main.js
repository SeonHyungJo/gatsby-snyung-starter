    ...
    <Layout {...props}>
      <div className="bContainer">
        <div className="bCard">
          ...
          <div className="title">
            자바스크립트 개발자가 되려고 하는 비전공자
          </div>
          <div className="sns">
            <Button type={'snsBtn'} to={'mailto:seonhyung.jo@gmail.com'}>
              <IoEmail size="1.5rem" />
            </Button>
            ...
            <Button
              type={'snsBtn'}
              to={'http://facebook.com/profile.php?id=100015515351267'}
            >
            ...
            <Button
              type={'snsBtn'}
              to={
                'https://youtube.com/channel/UCCs6KHf_Zo_iI2jfg_eqeDg?view_as=subscriber'
              }
            >
